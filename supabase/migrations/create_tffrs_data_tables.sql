-- Create tables for storing scraped TFFRS conference data

-- Conferences table
CREATE TABLE IF NOT EXISTS tffrs_conferences (
...
-- Teams table
CREATE TABLE IF NOT EXISTS tffrs_teams (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Performances table
CREATE TABLE IF NOT EXISTS tffrs_performances (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_tffrs_conferences_url ON tffrs_conferences(url);
CREATE INDEX IF NOT EXISTS idx_tffrs_teams_conference ON tffrs_teams(conference_id);
CREATE INDEX IF NOT EXISTS idx_tffrs_teams_gender ON tffrs_teams(gender);
CREATE INDEX IF NOT EXISTS idx_tffrs_performances_team ON tffrs_performances(team_id);
CREATE INDEX IF NOT EXISTS idx_tffrs_performances_category ON tffrs_performances(event_category);
